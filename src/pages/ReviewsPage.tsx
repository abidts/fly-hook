      ...
      <main className="pt-16 pb-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 sm:mt-16 max-w-2xl mx-auto">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-emerald-600 to-sky-600 p-6 sm:p-10 text-center shadow-xl shadow-emerald-500/20">
              ...
              <div className="relative">
                ...
                <a
                  ...
                  className="mt-6 inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 font-semibold text-emerald-600 transition-all hover:scale-105 hover:shadow-lg"
                >
